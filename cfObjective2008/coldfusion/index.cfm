...
<cfset MACHII_CONFIG_PATH = ExpandPath("com/universalmind/samples/employeemanager/config/mach-ii.xml") />
...
<cfset MACHII_DTD_PATH = ExpandPath('com/universalmind/samples/employeemanager/config/mach-ii_1_6_0.dtd') />
